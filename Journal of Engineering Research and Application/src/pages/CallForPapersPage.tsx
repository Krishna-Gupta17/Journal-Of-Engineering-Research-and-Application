        ...
        <div className="card p-8 bg-gradient-to-br from-navy-700 to-navy-900 text-white mb-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-3">
              <Link to="/submit-manuscript" className="inline-flex items-center gap-2 bg-ocean-500 hover:bg-ocean-600 text-white font-bold text-sm px-6 py-3 rounded-lg transition-colors">
                Submit Manuscript <ArrowRight className="w-4 h-4" />
              </Link>
              <Link to="/downloads" className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/25 text-white font-semibold text-sm px-5 py-3 rounded-lg transition-colors">
            ...
            <div className="card p-5">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <Link key={href} to={href} className="flex items-center gap-1.5 text-xs text-ocean-500 hover:text-ocean-600 hover:underline">
