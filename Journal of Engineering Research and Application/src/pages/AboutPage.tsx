    ...
    >
      <div className="max-w-4xl space-y-10">
        ...
        <section className="card p-6">
          ...
          <Link to="/aims-scope" className="text-xs text-ocean-500 hover:text-ocean-600 font-semibold flex items-center gap-1">
        ...
        <div className="flex flex-wrap gap-3">
          <Link to="/aims-scope" className="btn-primary">View Aims & Scope <ArrowRight className="w-4 h-4" /></Link>
          <Link to="/editorial-board" className="btn-secondary">Editorial Board</Link>
          <Link to="/submit-manuscript" className="btn-accent">Submit a Manuscript</Link>
        </div>
