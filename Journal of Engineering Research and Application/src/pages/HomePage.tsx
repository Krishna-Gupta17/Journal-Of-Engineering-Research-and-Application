    ...
    <div className="bg-[var(--color-bg)]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3">
              <Link to="/submit-manuscript" className="inline-flex items-center gap-2 px-6 py-3 bg-ocean-500 hover:bg-ocean-600 text-white font-semibold text-sm rounded-lg transition-colors shadow-lg">
                <FileText className="w-4 h-4" /> Submit Manuscript
              </Link>
              <Link to="/current-issue" className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 border border-white/30 text-white font-semibold text-sm rounded-lg transition-colors">
                <BookOpen className="w-4 h-4" /> View Current Issue
              </Link>
              <Link to="/downloads" className="inline-flex items-center gap-2 px-6 py-3 bg-teal-600/90 hover:bg-teal-600 text-white font-semibold text-sm rounded-lg transition-colors">
        ...
        <div className="flex gap-8 lg:gap-10">
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link to="/current-issue" className="btn-secondary text-xs hidden sm:inline-flex items-center gap-1">View All <ChevronRight className="w-3 h-3" /></Link>
            </div>
          ...
          <aside className="w-72 flex-shrink-0 hidden lg:flex flex-col gap-5">
            <div className="card p-5">
              ...
              <div className="space-y-4">
                {ANNOUNCEMENTS.map(ann => (
                  <div key={ann.id} className="border-b border-gray-100 dark:border-navy-800 pb-3 last:border-0 last:pb-0">
                    ...
                    <Link to="/announcements" className="block text-xs font-medium text-gray-800 dark:text-gray-200 hover:text-navy-700 dark:hover:text-white leading-snug mb-1">{ann.title}</Link>
              ...
              <Link to="/announcements" className="mt-3 text-xs text-ocean-500 hover:text-ocean-600 flex items-center gap-1 font-medium">All announcements <ArrowRight className="w-3 h-3" /></Link>
            </div>
            ...
            <div className="card p-5 bg-gradient-to-br from-teal-50 to-teal-100/50 dark:from-teal-900/20 dark:to-teal-900/10 border-teal-200 dark:border-teal-800">
              ...
              <Link to="/call-for-papers" className="btn-accent text-xs w-full justify-center">Learn More & Submit</Link>
            </div>
            ...
            <div className="card p-5">
              ...
              <Link to="/editorial-board" className="mt-3 text-xs text-ocean-500 hover:text-ocean-600 flex items-center gap-1 font-medium">Full editorial board <ArrowRight className="w-3 h-3" /></Link>
            </div>
            ...
            <div className="card p-5">
              ...
              <div className="space-y-1">
                {[
                  ...
                  <Link key={href} to={href} className="block px-2 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-navy-700 hover:bg-navy-50 dark:hover:text-white dark:hover:bg-navy-800/40 rounded transition-colors">{label}</Link>
                ))}
              </div>
            </div>
          </aside>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-10 text-center">
          <Link to="/peer-review" className="btn-primary">Learn About Our Review Process <ArrowRight className="w-4 h-4" /></Link>
        </div>
      </section>
