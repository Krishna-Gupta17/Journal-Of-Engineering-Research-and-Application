    ...
    >
      <div className="max-w-4xl space-y-10">
        ...
        <div className="flex flex-wrap gap-3">
          <Link to="/submit-manuscript" className="btn-primary">Submit a Manuscript</Link>
          <Link to="/author-guidelines" className="btn-secondary">Author Guidelines</Link>
          <Link to="/ethics-policy" className="btn-secondary">Publication Ethics</Link>
        </div>
